...
//
//public class TestFillUI {
//    static TestFillUI testFillUI = null;
//    private static final int BOARD_SIZE_IN_SQUARES = 8;
//    private static final int SQUARE_SIZE_IN_CHARS = 3;
//    private static final int LINE_WIDTH_IN_CHARS = 0;
//    private static final String EMPTY = "   ";
...
//    TestFillUI() {}
//
//    static TestFillUI getTestFillUI(){
//        if(TestFillUI.testFillUI == null){
//            testFillUI = new TestFillUI();
//        }
//        return testFillUI;
//    }
//
//    void setTestboard(ChessBoard testboard) {
...
//    public static void main(String[] args) {
//        var out = new PrintStream(System.out, true, StandardCharsets.UTF_8);
//        TestFillUI myTestFillUI = getTestFillUI();
//
//        out.print(ERASE_SCREEN);
//
//        myTestFillUI.drawHeaders(out);
//
//        myTestFillUI.drawTicTacToeBoard(out);
//
//        out.print(SET_BG_COLOR_BLACK);
//        out.print(SET_TEXT_COLOR_WHITE);
//        testFillUI.setTestboard(new ChessBoard());
//    }
//
//    private static void drawHeaders(PrintStream out) {
//
